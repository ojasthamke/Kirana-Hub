...
// GET — vendor's own products (or all products in local mode)
export async function GET() {
    ...
    await dbConnect();
    // In local mode, show all products (admin mock). In prod, vendor sees only theirs.
...
export async function PATCH(req: Request) {
    ...
    try {
        ...
        await dbConnect();
        // In local mode, admin can edit any product. In prod, vendor only edits theirs.
